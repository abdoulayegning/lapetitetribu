...
<template>
    ...
    <div class="w-full h-[100vh] relative">  
        <div ref="roller">
            ...
            uppercase text-6xl mix-blend-difference top-1/2 -translate-y-1/2 pr-6 pl-6">
                pour des marques <span class="underline">ambitieuses</span>
            </div>
        </div> 
            ...
            <div class="flex flex-col"> 
                <div class="w-full font-['DM_Sans'] relative text-base font-light mt-16  p-12 rounded-3xl">  
                    ...
                    <!-- <div class="flex lg:flex-row flex-col gap-4">
                        ...
                        <div class="text-left leading-loose lg:text-6xl text-xl lg:w-4/5 w-full flex items-center font-regular font-['Inter']" ref="text">
                            <div>
                        ...
                        <div class="text-right leading-loose lg:text-base text-xl font-regular font-['Inter'] mt-20 font-medium uppercase">
                                the process
                        </div>
